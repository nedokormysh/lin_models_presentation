...
def corr_matrix(all_data, width=5, height=5):
    ...
    heatmap.set_title("Треугольная тепловая карта корреляции Пирсона", fontdict={"fontsize": 10}, pad=5)
